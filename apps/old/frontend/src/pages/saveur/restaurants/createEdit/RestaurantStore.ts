import { type IRestaurant, type ITag, _assert } from "@galadrim-tools/shared";
...
export class RestaurantStore {
    ...
    get averagePrice() {
        const price = Number.parseFloat(this.averagePriceText);
        if (this.averagePriceText === "" || Number.isNaN(price)) {
            return null;
        }
        return price;
    }
