...
export interface WorkplaceSvgProps {
   ...
   height: number;
   wallsColor: string;
   backgroundColor: (room: Room) => string;
   backgroundColorHover: (room: Room) => string;
   onClick: (room: Room) => void;
   onMouseOut: (room: Room) => void;
   onMouseOver: (room: Room) => void;
   style: (room: Room) => React.CSSProperties;
}
